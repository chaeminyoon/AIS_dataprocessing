"""
PHASE 2 (KD-Tree + 날짜별 저장): 궤적-격자 매칭 초고속 처리
...
def intersect_with_grid_kdtree(gdf_trajectories, gdf_grid, kdtree):
    ...
    print(f"    Processing trajectories with KD-Tree...")
...
def process_single_day(args):
    ...
    day_file, gdf_grid, kdtree, all_grid_ids = args
...
def main():
    ...
    print("=" * 70)
    print("PHASE 2: KD-Tree with Daily Save (All Grids)")
    print("=" * 70)
    ...
    args_list = [(f, gdf_grid, kdtree, all_grid_ids) for f in daily_files]
